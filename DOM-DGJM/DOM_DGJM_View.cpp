...
{
	int lado;
	printf("Essa peca pode ser jogada nas duas extremidades da mesa.\nDigite (1) para jogar no lado esquerdo ou (2) para jogar no lado esquerdo da mesa!\n");
	scanf("%d", &lado);
	if(lado == 1)
		return 1;
	else if(lado == 2)
